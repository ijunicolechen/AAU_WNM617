...
const makeProfileList = templater(
  (o) => `
<div class="user-container">
                        <div class="profile-imgBox margin-left-auto margin-right-auto">
                            <img src="${o.u_img}" alt="I-Chen">
                        </div>
                        <div class="profile-content" data-id="${o.u_id}">
                            <div class="edit-icon" data-activate=".profile-edit">
                                <?xml version="1.0" ?>
                            ...
                            <div class="user-information">
                                <h3>Da Miao</h3>
                                <div class="user-location">${o.u_city},${
    o.u_state
  }</div>
                    ...
                    <div class="list-container">
                        <div class="list-box">Change Password</div>
                        <div class="list-box">Change Theme</div>
                        <div class="list-box">Privacy Policy</div>
                        <div class="list-box">Rule of Tile</div>
                        <div class="list-box">Help</div>
                    </div>
                    <div id="logOut" class="btn-logout margin-left-auto margin-right-auto">Log Out</div>`
);
                        
const makeRecentWindow = templater(o => `
<div class="display-flex recent-cats">
	<div class="flex-none">
		<div class="recent-image">
		</div>
	</div>
	<div class="flex-stretch cats-data">
		<h2>${o.a_name.toUpperCase()}</h2>
		<div><strong>Type</strong> <span>${getString(o.a_type,"type")}</span></div>
		<div><strong>Breed</strong> <span>${o.b_name}</span></div>
		<div class="btn-visit">
			<a href="#catsInfoPage" class="form-button jump-catInfo" data-id="${o.a_id}">Visit</a>
		</div>
	</div>
</div>
`);